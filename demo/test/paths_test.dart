...
void main() {
  test('каталог приложения ищется вверх по pubspec.yaml с name: demo', () {
    final base = Directory('temp/paths_test/demo');
  ...
  test('пути файлов проверок, журнала и истории собираются от каталога', () {
    final paths = AppPaths(Directory('temp/paths_test/demo'));
