...
void main() {
  ...
  test('каталог полный: 50 фич в непустых группах', () {
    expect(kFeatureCatalog, hasLength(50));
    expect(kFeatureCatalog.map((f) => f.id).toSet(), hasLength(50));
