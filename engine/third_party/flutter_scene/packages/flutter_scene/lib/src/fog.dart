...
class Fog {
  ...
  /// Fog opacity at the [start] distance; the ramp interpolates toward
  /// [maxOpacity] by [end]. A nonzero base keeps near geometry hazed instead
  /// of perfectly clear at [start].
