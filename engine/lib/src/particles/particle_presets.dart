  ...
  static final ParticleConfig streetRain = ParticleConfig(
    ...
    sprites: const [
      ParticleDef(
        ...
        width: 0.05,
        height: 0.4,
        assetPath: 'packages/pet_engine/assets/particles/rain.png',
      ),
    ],
    maxPerCell: 10,
    fullDensityRings: 2,
  ...
  static final ParticleConfig passSnow = ParticleConfig(
    ...
    sprites: const [
      ParticleDef(
        ...
        width: 0.10,
        height: 0.10,
        assetPath: 'packages/pet_engine/assets/particles/snowflake_1.png',
      ),
      ParticleDef(
        ...
        width: 0.08,
        height: 0.08,
        assetPath: 'packages/pet_engine/assets/particles/snowflake_2.png',
      ),
    ],
    maxPerCell: 5,
    fullDensityRings: 2,
  ...
  static final ParticleConfig passWind = ParticleConfig(
    ...
    sprites: const [
      ParticleDef(
        ...
        width: 3.6,
        height: 0.3,
        assetPath: 'packages/pet_engine/assets/particles/wind_wisp.png',
      ),
    ],
    maxPerCell: 1,
    fullDensityRings: 12,
  ...
  static final ParticleConfig caveWindGlint = ParticleConfig(
    ...
    sprites: const [
      ParticleDef(
        ...
        width: 0.08,
        height: 0.08,
        assetPath: 'packages/pet_engine/assets/particles/wind_glint.png',
      ),
    ],
    maxPerCell: 1,
    fullDensityRings: 8,
