...
class PreprocessedMaterial extends Material implements HotReloadableFmat {
  ...
  /// The sidecar metadata this material was built from: the declared parameter
  /// schema (`parameters`, `samplers`), render state, and engine inputs. Kept
  /// in sync by [updateFromMetadata] on hot reload.
  ...
  /// The generated vertex-stage shaders for a `vertex { }` material, or null
  /// when the material does not customize the vertex stage.
  Map<String, gpu.Shader>? get vertexShaders => _vertexShaders;
